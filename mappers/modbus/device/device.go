...
import (
	...
	db "github.com/kubeedge/mapper-generator/mappers/modbus/data/dbprovider/influx"
	httpMethod "github.com/kubeedge/mapper-generator/mappers/modbus/data/publish/http"
	mqttMethod "github.com/kubeedge/mapper-generator/mappers/modbus/data/publish/mqtt"
	"github.com/kubeedge/mapper-generator/mappers/modbus/driver"
...
func (d *DevPanel) start(ctx context.Context, dev *driver.CustomizedDev) {
	defer d.wg.Done()
	tempProtocol := make(map[string]interface{})
	...
	if err := json.Unmarshal(dev.Instance.PProtocol.ProtocolConfigs, &tempProtocol); err != nil {
		klog.Errorf("Unmarshal ProtocolConfigs error: %v", err)
		return
	}
...
func dbHandler(ctx context.Context, twin *common.Twin, client *driver.CustomizedClient, visitorConfig *driver.VisitorConfig, dataModel *common.DataModel) {
	klog.V(1).Info("now in dbHandler")
...
func setVisitor(visitorConfig *driver.VisitorConfig, twin *common.Twin, dev *driver.CustomizedDev) error {
	...
	visitorConfig.Name = twin.PropertyName
